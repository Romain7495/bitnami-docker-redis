...
* [`6.0`, `6.0-debian-10`, `6.0.8`, `6.0.8-debian-10-r33`, `latest` (6.0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/6.0.8-debian-10-r33/6.0/debian-10/Dockerfile)
* [`5.0`, `5.0-debian-10`, `5.0.9`, `5.0.9-debian-10-r136` (5.0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.9-debian-10-r136/5.0/debian-10/Dockerfile)
...
A [replication](http://redis.io/topics/replication) cluster can easily be setup with the Bitnami Redis Docker Image using the following environment variables:
 ...
 - `REDIS_REPLICATION_PORT`: The replication announce port. Defaults to `REDIS_MASTER_PORT_NUMBER`.
